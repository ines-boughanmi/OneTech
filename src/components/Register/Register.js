    ...
    <div className="contain">
      ...
      <form className="input-group">
        ...
        <div className="form-group">
          ...
          {
            errors.lastNameError? <small className="text-danger" >{errors.lastNameError}</small> : <></>
          }
        </div>
        ...
        <div className="form-group">
          ...
          {
            errors.locationError? <small className="text-danger" >{errors.locationError}</small> : <></>
          }
        </div>
        ...
        <div className="form-group">
          ...
          {
            errors.phoneError? <small className="text-danger" >{errors.phoneError}</small> : <></>
          }
        </div>
        ...
        <div className="form-group">
          ...
          <div className="input-section">
          <input type={show2 ? "text" : "password"} className="form-control" id="confirmPassword" 
                    onChange={(e)=> setConfirmPassword(e.target.value)}
                    onBlur={(e)=> handlePasswordConfirm()}
                    value={confirmPassword}/>
                  
                    {
            show2 ? <FontAwesomeIcon icon={faEye} onClick={(e)=>setShow2(!show2)} /> : <FontAwesomeIcon icon={faEyeSlash} onClick={(e)=>setShow2(!show2)} /> 
          }
          </div>
        {
